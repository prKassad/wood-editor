 ...
 * @author prKassad / http://github.com/prKassad
 */
...
function EditorControls(object, domElement) {
    ...
    this.dispose = function () {
        ...
        domElement.removeEventListener('touchmove', touchMove, {passive: true});

    };

    domElement.addEventListener('contextmenu', contextmenu, false);
    domElement.addEventListener('mousedown', onMouseDown, false);
    domElement.addEventListener('wheel', onMouseWheel, {passive: true});
    ...
    domElement.addEventListener('touchstart', touchStart, {passive: true});
    domElement.addEventListener('touchmove', touchMove, {passive: true});
